...
UUID=${UUID:-'21f39415-886b-446e-9967-662332a1dbb6'}
VMESS_WSPATH=${VMESS_WSPATH:-'/vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/vless'}
URL=${USER}.alwaysdata.net

wget -q -O $TMP_DIRECTORY/config.json https://raw.githubusercontent.com/Tjurfasku/masaleai-forkte/main/config.json
